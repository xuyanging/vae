...
def pad_inputs(image, crop_height=H, crop_width=W, pad_value=0):
...
test_images = glob('/home/igs/Documents/soiling_dataset-all/test/rgbImages/*')
...
for img in tqdm(test_images):
    ...
    cv2.imwrite(f'seg/epoch_last/{fname}', cv2.cvtColor(result, cv2.COLOR_RGB2BGR))
